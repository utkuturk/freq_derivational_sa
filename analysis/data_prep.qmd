...
# packages
invisible(lapply(c("dplyr", "ggplot2", "tidyr", "readr", "purrr", "stringr", "knitr", "DT"), library, character.only = TRUE))
...
datatable(forms, options = list(pageLength = 5), rownames = FALSE)
```
